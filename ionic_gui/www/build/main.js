...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_backend_data__ = __webpack_require__(55);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_backend_data__ = __webpack_require__(55);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ProductPage = (function () {
    ...
    ProductPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-product',template:/*ion-inline-start:"C:\Users\kgross\Documents\private\print_app\source\label-pirint-app\ionic_gui\src\pages\product\product.html"*/'<ion-header>\n\n  <ion-navbar>\n\n    <button ion-button menuToggle>\n\n      <ion-icon name="menu"></ion-icon>\n\n    </button>\n\n    <ion-title>Šķirnes dati</ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content padding>\n\n  <ion-card>\n\n    <ion-list>\n\n\n\n  <ion-item>\n\n    <ion-label floating>Nosaukums</ion-label>\n\n    <ion-input type="text" [(ngModel)]="Nosaukums"></ion-input>\n\n  </ion-item>\n\n  <ion-item>\n\n    <ion-label floating>Bot. nos.</ion-label>\n\n    <ion-input type="text" [(ngModel)]="BotNosaukums"></ion-input>\n\n  </ion-item>\n\n\n\n  <ion-item>\n\n    <ion-label floating>Potcelms</ion-label>\n\n    <ion-input type="text" [(ngModel)]="Potcelms"></ion-input>\n\n  </ion-item>\n\n\n\n</ion-list>\n\n  <ion-buttons >\n\n      <button ion-button *ngFor="let x of potcelms_suggestions" (click)="set_potcelms(x)">{{x}}</button>\n\n    </ion-buttons>\n\n\n\n\n\n\n\n\n\n<button ion-button  full (click)="saglabaatSkirnesDatus()">Saglabāt</button>\n\n  </ion-card>\n\n</ion-content>\n\n'/*ion-inline-end:"C:\Users\kgross\Documents\private\print_app\source\label-pirint-app\ionic_gui\src\pages\product\product.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavParams */], __WEBPACK_IMPORTED_MODULE_4__providers_backend_data__["a" /* BackendData */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* ToastController */]])
    ], ProductPage);
    return ProductPage;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs_add_operator_map__ = __webpack_require__(54);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs_add_operator_map___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_rxjs_add_operator_map__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_backend_data__ = __webpack_require__(55);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ConfigurationPage = (function () {
    function ConfigurationPage(navCtrl, navParams, /*public http: Http,*/ /*private storage: Storage,*/ toastCtrl, backendData, alertCtrl) {
        this.navCtrl = navCtrl;
    ...
    ConfigurationPage.prototype.saveServerURL = function () {
        // set a key/value
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__providers_backend_data__ = __webpack_require__(55);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var MyApp = (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"C:\Users\kgross\Documents\private\print_app\source\label-pirint-app\ionic_gui\src\app\app.html"*/'<ion-split-pane>\n\n<ion-menu [content]="content">\n\n  <ion-header>\n\n    <ion-toolbar>\n\n      <ion-title>Menu</ion-title>\n\n    </ion-toolbar>\n\n  </ion-header>\n\n\n\n  <ion-content>\n\n    <ion-list>\n\n      <button menuClose ion-item (click)="go_to_homepage()">\n\n        Drukāt\n\n      </button>\n\n      <button menuClose ion-item (click)="go_to_list()">\n\n        Saraksts\n\n      </button>\n\n      <button menuClose ion-item (click)="go_to_config()">\n\n        Uzstādījumi\n\n      </button>\n\n<!--\n\n      <button menuClose ion-item *ngFor="let p of pages" (click)="openPage(p)">\n\n        {{p.title}}\n\n      </button>\n\n-->\n\n\n\n    </ion-list>\n\n  </ion-content>\n\n\n\n</ion-menu>\n\n\n\n<!-- Disable swipe-to-go-back because it\'s poor UX to combine STGB with side menus -->\n\n<ion-nav [root]="rootPage" #content swipeBackEnabled="false" main></ion-nav>\n\n</ion-split-pane>\n\n'/*ion-inline-end:"C:\Users\kgross\Documents\private\print_app\source\label-pirint-app\ionic_gui\src\app\app.html"*/
        }),
