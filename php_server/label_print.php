...
try {
    ...
    $printer->getPrintConnector()->write($my_command);
     ...
     //  $printer -> selectCharacterTable(32);
...
$printable_text = "zzzāzšxxcģčb";
$encoded_text_for_printer = encode_4_printer($printable_text, $encoding_map );

print ($encoded_text_for_printer);
