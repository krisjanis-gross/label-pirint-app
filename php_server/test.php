...
require_once ('escpos-php/src/Mike42/Escpos/EscposImage.php');
...
try {
    ...
    //$line1_left = "Augu pase -AZ / Plant passport-PZ ERWIRAM";
  //  $line1_right = "Suga Potcelms";

    $line1_left = "1234567890123456789012345678901234567890";
    $line1_right = "123456789012";
    ...
    $combined_line = cobine_left_and_right_lines($line1_left, $line1_right);





    print("l: $line1_left <br/>");
    print("r: $line1_right<br/>");
    print("c: $combined_line<br/>");

/*
    $print_data = $combined_line;
    $line1_encoded = encode_4_printer($print_data, $encoding_map );
...
*/
    ...
    $img = EscposImage::load("flag_black_white50x30.png");
...
/*
    $left_margin_column2 = 90;
    $my_command = Printer::ESC . "l" . chr($left_margin_column2);
    $printer->getPrintConnector()->write($my_command);

    $print_data2 = "Suga Potcelms";
    $line1_encoded2 = encode_4_printer($print_data2, $encoding_map );
    $printer -> textRaw( $line1_encoded2 );
*/
    $printer -> text("\n");
